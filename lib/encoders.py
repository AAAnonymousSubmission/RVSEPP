...
def get_image_encoder(opt, data_name, img_dim, embed_size, precomp_enc_type='basic',
    ...
    if precomp_enc_type == 'basic':
        img_enc = EncoderImageAggr(
            opt, img_dim, embed_size, precomp_enc_type, no_imgnorm)
...
class EncoderImageAggr(nn.Module):
    def __init__(self, opt, img_dim, embed_size, precomp_enc_type='basic', no_imgnorm=False):
